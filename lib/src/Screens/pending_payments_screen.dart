              ...
              Expanded(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    List<String> pendingUsersList = [];
                    for (var doc in snapshot.data!.docs) {
                      pendingUsersList.add(doc.get('Username'));
                      for (var entry in doc.get('Account Transactions')) {
                        ...
                        if (dateController.text.isNotEmpty) {
                          ...
                          if (formattedDate.year == newformattedDate.year &&
                            ...
                            pendingUsersList.remove(doc.get('Username'));
                          } else {
                            continue;
                          }
                        }
                    ...
                    if (dateController.text.isEmpty) {
                    ...
                    } else if (dateController.text.isNotEmpty && pendingUsersList.isEmpty) {
                      return Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(
                              'No pending payments for the selected month and year.',
                              style: TextStyle(
                                color: Colors.blueAccent.shade700,
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
                      ...
                      return Padding(
                        ...
                        child: ListView.builder(
                          itemCount: pendingUsersList.toSet().length,
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                  pendingUsersList.toSet().toList()[index],
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 22,
